...
# -------------------- CONFIG --------------------
# Replace below values if needed. I left your token and admin id you gave earlier.
TELEGRAM_TOKEN = "8358721170:AAGOG7151_fNYEtiNXaXCrd3r01bx3nkCDY"
ADMIN_ID = 6307001401  # numeric Telegram user id for admin notifications

# TwelveData API key (you provided earlier)
TWELVE_API_KEY = "660529fb84264c2d8fceb72ffc756770"
TD_BASE = "https://api.twelvedata.com"

# Paths
APP_DIR = os.path.expanduser("~/trading_bot")
LOGS_DIR = os.path.join(APP_DIR, "logs")
os.makedirs(LOGS_DIR, exist_ok=True)

APPROVED_FILE = os.path.join(APP_DIR, "approved_users.json")
PENDING_FILE = os.path.join(APP_DIR, "pending_users.json")
PID_FILE = os.path.join(APP_DIR, ".lekzy_bot.pid")
SIGNALS_CSV = os.path.join(LOGS_DIR, "signals.csv")

# Behaviour / timing (customize)
PRE_ALERT_SECONDS = 60        # seconds before entry to send pre-alert
RESULT_DELAY = 120            # seconds after entry to determine result (2 minutes)
POST_GAP_MIN = 120            # seconds minimum gap after a signal
POST_GAP_MAX = 180            # seconds max gap after a signal
REQUIRED_CONFIRMATIONS = 3    # number of indicators required
MIN_CONFIDENCE = 60          # minimum confidence % to send signal

# Indicator params (tunable)
EMA_FAST = 9
EMA_SLOW = 21
MACD_FAST = 12
MACD_SLOW = 26
